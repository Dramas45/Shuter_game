...
class Hero(GameSprite): 
    ...
    def fireS(self):
        ...
        if firet - lastFire >= fireCooldpwn:
            lastFire = firet
            bullets.add(Bullet('bullet.png', self.rect.x + 22, self.rect.y, 15, 20, 4))
            fire_sound.play()
...
asteroids.add(Enemy_1('asteroid.png', 150, 0, 80, 50, 4))
asteroids.add(Enemy_1('asteroid.png', 370, 0, 80, 50, 3))
...
finish_lose = False
finish_win = False
win = font.render('YOU WIN!', True, (255, 225, 225)) 
lose = font.render('YOU LOSE!', True, (255, 225, 225)) 
